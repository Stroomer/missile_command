...
export default class Game {
  ...
  createObjects() {
    ...
    this.aliens = [];
    this.aliens.push(new Alien(100, 140, sprites));

    this.background.draw(this.bufferBackground);
    //this.aliens[0].draw(this.bufferEntities);

    // warning: ALIEN-sprites should update within their bounds and then be rendered (NOT full scale)
  }
}
